 ...
 */
public class GetInventoryIssueInfo {

    private Object RecommendBatches;
    /**
     * TrsCode : 101
     * TrsName : 生产领用调拨
     */
    ...
    private List<InventoryIssuetLine.Batchesbean> batches;

    public Object getRecommendBatches() {
        return RecommendBatches;
    }

    public void setRecommendBatches(Object RecommendBatches) {
    ...
    public List<InventoryIssuetLine.Batchesbean> getBatches() {
        return batches;
    }

    public void setBatches(List<InventoryIssuetLine.Batchesbean> batches) {
