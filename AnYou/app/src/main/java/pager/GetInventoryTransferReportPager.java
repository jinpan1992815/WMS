...
import bean.GetInventoryTransferReport;
 ...
 */
public class GetInventoryTransferReportPager extends Fragment {
    ...
    private List<GetInventoryTransferReport> list;
    ...
    public GetInventoryTransferReportPager(final ProgressDialog progressDialog, final Context context) {
        this.context = context;
        this.progressDialog = progressDialog;

        rootView = View.inflate(context, R.layout.pager_getinventorytransferreport, null);
        ...
        keyword.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                HttpUtils.getResult(Constant.HOST_getInventoryTransferReport, json, callBack);
                return false;
            }
        });
    }
    ...
    private Callback callBack = new Callback() {
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            Type listType = new TypeToken<List<GetInventoryTransferReport>>() {
            }.getType();
            try {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            GetInventoryTransferReport getInventoryTransferReport = list.get(position);
            if (convertView == null) {
                holder = new ViewHolder();
                convertView = View.inflate(context, R.layout.fg_item5_7, null);
            ...
            holder.tv1.setText(getInventoryTransferReport.getDocEntry());
            holder.tv2.setText(getInventoryTransferReport.getDocDate());
            holder.tv3.setText(getInventoryTransferReport.getDscription());
            holder.tv4.setText(CommonUtils.addComma(String.valueOf(getInventoryTransferReport.getBagAmount())));
            holder.tv5.setText(CommonUtils.addComma(String.valueOf(getInventoryTransferReport.getWhsQty())));
            holder.tv6.setText(getInventoryTransferReport.getFromWhs());
            holder.tv7.setText(getInventoryTransferReport.getToWhs());
            return convertView;
        }
