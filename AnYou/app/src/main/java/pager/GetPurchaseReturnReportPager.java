...
import bean.GetPurchaseReturnReport;
 ...
 */
public class GetPurchaseReturnReportPager extends Fragment {
    ...
    private List<GetPurchaseReturnReport> list;
    ...
    public GetPurchaseReturnReportPager(final ProgressDialog progressDialog, final Context context) {
        this.context = context;
        this.progressDialog = progressDialog;

        rootView = View.inflate(context, R.layout.pager_getpurchasereturnreport, null);
        ...
        keyword.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                HttpUtils.getResult(Constant.HOST_getPurchaseReturnReport, json, callBack);
                return false;
            }
        });
    }
    ...
    private Callback callBack = new Callback() {
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            Type listType = new TypeToken<List<GetPurchaseReturnReport>>() {
            }.getType();
            try {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            GetPurchaseReturnReport getPurchaseReturnReport = list.get(position);
            if (convertView == null) {
                holder = new ViewHolder();
                convertView = View.inflate(context, R.layout.fg_item5_3, null);
            ...
            holder.tv1.setText(getPurchaseReturnReport.getDocType());
            holder.tv2.setText(getPurchaseReturnReport.getCardName());
            holder.tv3.setText(getPurchaseReturnReport.getDocDate());
            holder.tv4.setText(getPurchaseReturnReport.getDocEntry());
            holder.tv5.setText(getPurchaseReturnReport.getDocEntry2());
            holder.tv6.setText(getPurchaseReturnReport.getDscription());
            holder.tv7.setText(CommonUtils.addComma(String.valueOf(getPurchaseReturnReport.getPOQty())));
            holder.tv8.setText(CommonUtils.addComma(String.valueOf(getPurchaseReturnReport.getWhsQty())));
            return convertView;
        }
