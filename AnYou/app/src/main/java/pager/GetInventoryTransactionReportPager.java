...
import bean.GetInventoryTransactionReport;
 ...
 */
public class GetInventoryTransactionReportPager extends Fragment {
    ...
    private List<GetInventoryTransactionReport> list;
    ...
    public GetInventoryTransactionReportPager(final ProgressDialog progressDialog, final Context context) {
        this.context = context;
        this.progressDialog = progressDialog;

        rootView = View.inflate(context, R.layout.pager_getinventorytransactionreport, null);
        ...
        keyword.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                HttpUtils.getResult(Constant.HOST_getInventoryTransactionReport, json, callBack);
                return false;
            }
        });
    }
    ...
    private Callback callBack = new Callback() {
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            Type listType = new TypeToken<List<GetInventoryTransactionReport>>() {
            }.getType();
            try {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            GetInventoryTransactionReport getInventoryTransactionReport = list.get(position);
            if (convertView == null) {
                holder = new ViewHolder();
                convertView = View.inflate(context, R.layout.fg_item5_5, null);
            ...
            holder.tv1.setText(getInventoryTransactionReport.getTransName());
            holder.tv2.setText(getInventoryTransactionReport.getDocEntry());
            holder.tv3.setText(getInventoryTransactionReport.getDocType());
            holder.tv4.setText(getInventoryTransactionReport.getDocDate());
            holder.tv5.setText(getInventoryTransactionReport.getDepartment());
            holder.tv6.setText(getInventoryTransactionReport.getDscription());
            holder.tv7.setText(CommonUtils.addComma(String.valueOf(getInventoryTransactionReport.getWhsQty())));
            return convertView;
        }
