 ...
 */
public class GetInformedReportPager extends Fragment {
    ...
    private List<GetInformedReport> list;
    ...
    public GetInformedReportPager(final ProgressDialog progressDialog, final Context context) {
        this.context = context;
        this.progressDialog = progressDialog;

        rootView = View.inflate(context, R.layout.pager_getinformedreport, null);
        ...
        keyword.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                HttpUtils.getResult(Constant.HOST_getInformedReport, json, callBack);
                return false;
            }
        });
    }
    ...
    private Callback callBack = new Callback() {
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            Type listType = new TypeToken<List<GetInformedReport>>() {
            }.getType();
            try {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            GetInformedReport getInformedReport = list.get(position);
            if (convertView == null) {
                holder = new ViewHolder();
                convertView = View.inflate(context, R.layout.fg_item5_1, null);
            ...
            holder.tv1.setText(getInformedReport.getDocEntry2());
            holder.tv2.setText(getInformedReport.getDeliveryDate());
            holder.tv3.setText(getInformedReport.getCardName());
            holder.tv4.setText(getInformedReport.getItemName());
            holder.tv5.setText(getInformedReport.getBaseEntry());
            holder.tv6.setText(CommonUtils.addComma(String.valueOf(getInformedReport.getPlanQty())));
            holder.tv7.setText(getInformedReport.getDocEntry());
            holder.tv8.setText(getInformedReport.getQuantity());
            return convertView;
        }
